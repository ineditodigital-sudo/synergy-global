...
import { Scale, Users, FileSignature, MoveRight, CheckCircle2, MessageSquare } from 'lucide-react';
import { Link } from 'react-router-dom';
import SEO from '../../components/SEO';

export default function BusinessAdvocacy() {
  ...
  const capabilities = [
    {
      title: "Public Affairs Strategy",
      desc: "Navigating legislative and regulatory environments to protect and advance client interests.",
      icon: <Scale size={24} />
    },
    {
      title: "Stakeholder Engagement",
      desc: "Building critical alliances with government entities and private sector leaders.",
      icon: <Users size={24} />
    },
    {
      title: "Real Estate Representation",
      desc: "Advocating for commercial and industrial real estate developments across borders.",
      icon: <FileSignature size={24} />
    },
    {
      title: "Crisis Communications",
      desc: "Managing high-stakes corporate communication and reputational risk.",
  ...
  return (
    <div ref={containerRef} className="bg-bone min-h-screen text-sage">
      <SEO 
        ...
        description="Advocacy for all businesses and real estate related companies in the U.S. and Mexico." 
      />
      ...
      <section className="hero-container relative h-[65vh] md:h-[75vh] flex items-center justify-center overflow-hidden bg-charcoal">
        <div className="absolute inset-0 w-full h-full">
          <img 
            src="https://images.unsplash.com/photo-1577415124268-bfc11c138d56?auto=format&fit=crop&q=80&w=2000" 
            alt="Business Advocacy" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 w-full text-center md:text-left pt-20 md:pt-32">
          <div className="max-w-4xl">
            ...
            <h1 className="hero-title font-heading text-5xl md:text-7xl lg:text-8xl text-white leading-[0.95] mb-8">
              Business <br />
              <span className="italic text-sand ml-0 md:ml-16">Advocacy.</span>
            </h1>
            ...
            <p className="hero-desc font-sans font-light text-lg md:text-xl text-bone/60 max-w-xl leading-relaxed italic">
              "Defending interests and advancing initiatives for enterprises in the U.S. and Mexico."
            </p>
          </div>
        </div>
      ...
      <section className="py-32 px-6 md:px-16 border-b border-sand/10">
        <div className="max-w-7xl mx-auto mb-20 animate-up">
          ...
          <h3 className="font-heading text-4xl md:text-5xl text-sage">Influence <span className="italic">Engineered.</span></h3>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24">
          <div className="animate-up">
            ...
            <p className="font-heading text-4xl text-sage leading-tight mb-8">
              Securing outcomes through <br />
              <span className="italic">strategic advocacy.</span>
            </p>
            ...
            <ul className="space-y-4">
              {["Government Relations", "Policy Shaping", "Real Estate Entitlements"].map((item, i) => (
      ...
      <section className="py-32 bg-charcoal text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center animate-up relative z-10">
          <h3 className="font-heading text-4xl md:text-5xl mb-8">Need strategic representation?</h3>
