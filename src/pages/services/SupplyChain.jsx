...
import { Globe, Truck, Package, BarChart3, MoveRight, CheckCircle2 } from 'lucide-react';
...
export default function SupplyChain() {
  ...
  const capabilities = [
    ...
    },
    {
      ...
      desc: "Data-driven insights into supply chain trends and manufacturing opportunities.",
      icon: <BarChart3 size={24} />
    },
    {
      title: "Global Distribution",
      desc: "End-to-end management of specialized supply chain markets for institutional clients.",
      icon: <Globe size={24} />
    }
  ];
  ...
  return (
    <div ref={containerRef} className="bg-bone min-h-screen text-sage">
      <SEO 
        title="Supply Chain & International Trade" 
        description="Strategic global logistics and manufacturing supply chain management." 
      />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 w-full text-center md:text-left pt-20 md:pt-32">
          <div className="max-w-4xl">
            ...
            <h1 className="hero-title font-heading text-5xl md:text-7xl lg:text-8xl text-white leading-[0.95] mb-8">
              Supply <br />
              <span className="italic text-sand ml-0 md:ml-16">Chain.</span>
            </h1>
            ...
            <p className="hero-desc font-sans font-light text-lg md:text-xl text-bone/60 max-w-xl leading-relaxed italic">
              "Engineering cross-border intelligence through specialized distribution and strategic operational excellence."
            </p>
          </div>
        </div>
      ...
      <section className="py-32 px-6 md:px-16 border-b border-sand/10">
        <div className="max-w-7xl mx-auto mb-20 animate-up">
          ...
          <h3 className="font-heading text-4xl md:text-5xl text-sage">Operational <span className="italic">Excellence.</span></h3>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24">
          <div className="animate-up">
            ...
            <p className="font-heading text-4xl text-sage leading-tight mb-8">
              ...
              <span className="italic">production</span> to consumption.
            </p>
            <p className="font-sans font-light text-lg text-sage/70 leading-relaxed mb-8">
              Synergy Global provides a comprehensive framework for manufacturing and distribution. We don't just move goods; we engineer ecosystems that allow businesses to scale with absolute confidence across international borders.
            </p>
            <ul className="space-y-4">
              {["Customs & Regulatory Alignment", "Just-in-Time Distribution", "Asset Optimization"].map((item, i) => (
      ...
      <section className="py-32 bg-charcoal text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center animate-up relative z-10">
          <h3 className="font-heading text-4xl md:text-5xl mb-8">Ready to optimize your global operations?</h3>
